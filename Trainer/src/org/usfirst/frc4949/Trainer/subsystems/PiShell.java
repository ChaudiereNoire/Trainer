...
public class PiShell{
 
   private static String USERNAME ="pi"; // username for remote host
   private static String PASSWORD ="raspb3rry"; // password of the remote host
   private static String host = "10.49.49.195"; // remote host address
