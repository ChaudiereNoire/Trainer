...
/**
 *  This class came from code used by Team 1111, the Power Hawks.  If you use it,
 *  you have to set your own package name, and there is also a spot where the current 
 *  method is called out by splitting class names on the team number.  You will want 
 *  to set that number to your own to get a good output.
 */
...
//          }
    ...
    private static String currentMethod(Integer level)    {
    	...
    	try  {
    		String method = stackTrace[level].toString().split("4949.")[1];
